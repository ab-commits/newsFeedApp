...
WorkFlow
1. Run the script inside scripts folder either run go run load_data.go or ./scripts.exe .It will load the MongoDb with the data supplied.I was running MongoDb on a container and exposed the port to connect to my backend.
